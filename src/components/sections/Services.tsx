...
const services = [
  {
    ...
    description: 'Reliable transportation to and from routine medical appointments, specialist visits, and follow-up care.',
    icon: (
  ...
  {
    title: 'Dialysis & Treatment Centers',
    description: 'Timely transport for patients undergoing dialysis, chemotherapy, and other regular treatments.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Safe and comfortable transport for patients being discharged from hospitals or care facilities.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Wheelchair & Stretcher Services',
    description: 'Accessible transportation options for individuals requiring wheelchairs or stretchers.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Customized solutions for patients with unique medical or mobility needs.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
